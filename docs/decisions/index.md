...
| [ADR-012 · Host/device acceptance catalog](ADR-012-host-device-acceptance-catalog.md) | Accepted (2026-09-18) | Architectural decision only; HT-1…HT-12 methodology and device/OS scope policy (D) decided; device/chip-tier scope itself still owner-open; no test/host/device/CI implementation authorized | ADR-001, ADR-007, ADR-008, ADR-009, ADR-010 |
