...
| [ADR-010 · Device/lifecycle matrix](ADR-010-device-lifecycle-matrix.md) | Accepted (2026-09-18) | Architectural decision only; minimum deployment target set as a rolling "current major version minus one" (iOS/iPadOS 25+ as of acceptance); no wrapper/UI/dependency implementation authorized | ADR-001, ADR-003, ADR-005, ADR-007 |
