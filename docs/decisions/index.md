...
| [ADR-009 · Production bus policy](ADR-009-production-bus-policy.md) | Accepted (2026-09-18); four more items decided 2026-09-19 | Architectural decision only; bus layout decided (stereo-in/stereo-out, sum-to-mono, now interim); bypass tradeoff decided as hybrid (undesigned); multi-channel decided as not a target; `canProcessInPlace = true` recommended; kill-tail-on-bypass explicitly deferred; no wrapper/UI/dependency implementation authorized | ADR-001, ADR-003, ADR-004, ADR-006, ADR-007 |
| [ADR-010 · Device/lifecycle matrix](ADR-010-device-lifecycle-matrix.md) | Accepted (2026-09-18); floor corrected 2026-09-19 | Architectural decision only; minimum deployment target set as a rolling "current major version minus one" (iOS/iPadOS 26+, corrected from 25+ — see ADR-010's "Correction note"); no wrapper/UI/dependency implementation authorized | ADR-001, ADR-003, ADR-005, ADR-007 |
| [ADR-011 · State schema](ADR-011-state-schema.md) | Accepted (2026-09-18) | Architectural decision only; payload shape, versioning, invalid/mismatch policy and atomic 3-parameter restore decided; names two unimplemented `ParameterAutomation` obligations (read-back accessor, `setAll`); no wrapper/UI/dependency implementation authorized | ADR-001, ADR-004, ADR-007, ADR-008 |
| [ADR-012 · Host/device acceptance catalog](ADR-012-host-device-acceptance-catalog.md) | Accepted (2026-09-18); device/chip-tier scope decided 2026-09-19 | Architectural decision only; HT-1…HT-12 methodology and device/OS scope policy (D) decided; device/chip-tier scope decided as per-family corners (iPhone SE 2nd gen/A13 + newest iPhone; iPad 8th gen/A12 + newest iPad Pro); no test/host/device/CI implementation authorized | ADR-001, ADR-007, ADR-008, ADR-009, ADR-010 |
