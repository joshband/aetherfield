...
| [ADR-007 · AUv3 integration comparison](ADR-007-auv3-integration-comparison.md) | Proposed; owner acceptance pending | Documentation-only comparison; no wrapper, UI or dependency implementation authorized | ADR-001, ADR-004, ADR-006 |
