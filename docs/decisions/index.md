...
| [ADR-008 · Parameter-event bridge](ADR-008-parameter-event-bridge.md) | Proposed | Design only; no bridge/wrapper/UI/dependency implementation authorized | ADR-001, ADR-004, ADR-007 |
| [ADR-009 · Production bus policy](ADR-009-production-bus-policy.md) | Proposed | Architectural decision only; no wrapper/UI/dependency implementation authorized | ADR-001, ADR-003, ADR-006, ADR-007 |
