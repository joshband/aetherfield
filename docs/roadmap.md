...
- [ADR-011](decisions/ADR-011-state-schema.md) — **accepted (2026-09-18)**:
  ...
  not authorized by drafting or accepting this record. **Design finalized
  2026-09-19** (signatures, thread-safety, `setAll`'s validation contract,
  and pre-render snap sequencing) — see ADR-011's "Design note"; still
  unimplemented and still unauthorized.
